...
include("../Connection/config.php");
    if(isset($_POST['submit'])){
        ...
        $now = date("Y-m-d");
        $query= "INSERT INTO riwayat_topup (user_id, saldo, bukti_topup, tanggal_topup) VALUES ((SELECT id FROM users WHERE username='$username' AND password='$password'), '$topup', '$bukti', '$now')";
