<?php 
    ...
    if(isset($_POST['submitPenerimaanSaldoPembayaran'])){
        ...
        $query = "UPDATE detail_saldo SET cop_karantina = '$cop_karantina', phqc_karantina='$phqc_karantina', pnbp_labuh = '$pnbp_labuh', pnbp_mc = '$pnbp_mc', pnbp_rambu='$pnbp_rambu', buku_kesehatan_karantina='$buku_karantina', total_trip='$total_trip', tanggal_terima='$tanggal_terima', foto_rincian='$rincian', catatan = '$catatan' WHERE id = $id_penerimaan";
